...
export function TwoColumn({
  ...
  onSelectElement,
}: TwoColumnProps & WithDraggableProps & {
  ...
  const leftDraggable = useDraggableWrapper(
    'left',
    positions,
    onUpdate,
    isPositioningEnabled,
  ...
  const rightDraggable = useDraggableWrapper(
    'right',
    positions,
    onUpdate,
    isPositioningEnabled,
    ...
    >
      ...
      <div className={`grid ${gridCols[split]} gap-12 flex-1`}>
        ...
        <div className="flex flex-col justify-center">
          {typeof left === "string" ? leftDraggable.wrapWithDraggable(
            <EditableText
              value={left}
        ...
        {/* Right Column */}
        <div className="flex flex-col justify-center">
          {typeof right === "string" ? rightDraggable.wrapWithDraggable(
            <EditableText
              value={right}
